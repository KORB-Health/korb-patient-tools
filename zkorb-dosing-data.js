...
var KORB_DOSING = {
  ...
  meta: {
    ...
    changelog: [
      ...
      '2026-08-10 (v1.2): Rest-day language corrected across all 6-on/1-off agents ' +
      '(Sermorelin x4, CJC-1295/Ipamorelin x3, Tesamorelin x3 = 20 sig strings, ' +
      '10 agents.schedule fields). Dr. Rose confirmed the protocol is 6 days on, ' +
      '1 day off, and that the specific weekday is a RECOMMENDATION for ease of ' +
      'patient recall, not a clinical requirement. Sunday is no longer stated as a ' +
      'fixed rest day. Sig text now reads "6 days on, 1 day off (Monday through ' +
      'Saturday recommended)". Sig word order was normalised so all three agent ' +
      'families share one structure; the CJC-1295/Ipamorelin sig previously led ' +
      'with the weekday rather than the timing. BPC-157 (daily) and GHK-Cu ' +
      '(3x weekly, Mon/Wed/Fri already phrased as an example) are unaffected. ' +
      'EXACT SIG WORDING STILL NEEDS A CONFIRM FROM DR. ROSE BEFORE IT REACHES ' +
      'THE PHARMACIES via Tebra Compounded Drug Favorite fields.'
    ]
  },
  ...
  instructions: {
    sermorelin: {
      premier:   'Inject 20 units subcutaneously at bedtime, 6 days on, 1 day off (Monday through Saturday recommended), on an empty stomach.',
      greenwich: 'Inject 7 units subcutaneously at bedtime, 6 days on, 1 day off (Monday through Saturday recommended), on an empty stomach.'
    },
    sermorelin300: {
      premier:   'Inject 30 units subcutaneously at bedtime, 6 days on, 1 day off (Monday through Saturday recommended), on an empty stomach.',
      greenwich: 'Inject 10 units subcutaneously at bedtime, 6 days on, 1 day off (Monday through Saturday recommended), on an empty stomach.'
    },
    sermorelin400: {
      premier:   'Inject 40 units subcutaneously at bedtime, 6 days on, 1 day off (Monday through Saturday recommended), on an empty stomach.',
      greenwich: 'Inject 13 units subcutaneously at bedtime, 6 days on, 1 day off (Monday through Saturday recommended), on an empty stomach.'
    },
    sermorelin500: {
      premier:   'Inject 50 units subcutaneously at bedtime, 6 days on, 1 day off (Monday through Saturday recommended), on an empty stomach.',
      greenwich: 'Inject 17 units subcutaneously at bedtime, 6 days on, 1 day off (Monday through Saturday recommended), on an empty stomach.'
    },
    bpc157: {
    ...
    cjcipam: {
      premier:   'Inject 5 units subcutaneously at bedtime, 6 days on, 1 day off (Monday through Saturday recommended), on an empty stomach.',
      greenwich: 'Inject 5 units subcutaneously at bedtime, 6 days on, 1 day off (Monday through Saturday recommended), on an empty stomach.'
    },
    cjcipam150: {
      premier:   'Inject 7.5 units subcutaneously at bedtime, 6 days on, 1 day off (Monday through Saturday recommended), on an empty stomach.',
      greenwich: 'Inject 7.5 units subcutaneously at bedtime, 6 days on, 1 day off (Monday through Saturday recommended), on an empty stomach.'
    },
    cjcipam200: {
      premier:   'Inject 10 units subcutaneously at bedtime, 6 days on, 1 day off (Monday through Saturday recommended), on an empty stomach.',
      greenwich: 'Inject 10 units subcutaneously at bedtime, 6 days on, 1 day off (Monday through Saturday recommended), on an empty stomach.'
    },
    ghkcu: {
    ...
    tesamorelin1mg: {
      premier:   'Inject 20 units subcutaneously every evening, 6 days on, 1 day off (Monday through Saturday recommended).',
      greenwich: 'Inject 33 units subcutaneously every evening, 6 days on, 1 day off (Monday through Saturday recommended).'
    },
    tesamorelin15mg: {
      premier:   'Inject 30 units subcutaneously every evening, 6 days on, 1 day off (Monday through Saturday recommended).',
      greenwich: 'Inject 50 units subcutaneously every evening, 6 days on, 1 day off (Monday through Saturday recommended).'
    },
    tesamorelin2mg: {
      premier:   'Inject 40 units subcutaneously every evening, 6 days on, 1 day off (Monday through Saturday recommended).',
      greenwich: 'Inject 67 units subcutaneously every evening, 6 days on, 1 day off (Monday through Saturday recommended).'
    }
  },
  ...
  agents: {
    sermorelin: {
      ...
      schedule: '6 days on, 1 day off · Monday–Saturday recommended', timing: 'Bedtime · Empty stomach (2+ hrs after eating)',
    ...
    tesamorelin1mg: {
      ...
      onWeeksFoundation: [1, 12],
      schedule: '6 days on, 1 day off · Monday–Saturday recommended', timing: 'Evening',
      how: 'Subcutaneous (SQ) injection — fatty tissue under the skin',
      pillLabel: '6 on / 1 off', pillBg: '#21275B'
    },
    tesamorelin15mg: {
