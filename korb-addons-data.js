...
var KORB_ADDONS = {
  ...
  rxSignoff: {
    ...
    /* Signed 2026-09-15. Don reviewed each of these on screen, one at a time,
      ...
      "addon:addons": {
        ...
        "note": "Approved 2026-09-17 after the Allow Substitution row, the day-supply tile, the nine commercial entries moved to Tebra Standard prescriptions, the FDA compounded topical finasteride alert, the per-bottle pump rules on the hair topicals and the NAD+ favorite names: \"That looks good.\""
      },
    ...
    /* Superseded records. Not read by rx-signoff.js; kept because a sign-off
       ...
       exists to show. Same shape as korb-womens-data.js. */
    superseded: [
      {
        "key": "addon:addons",
        "signedBy": "Donald Stevenson, PA-C",
        ...
        "supersededBecause": "Nine blocks moved from Compounded Drug Favorite to " +
          "Tebra Standard prescription, every favorite name lost its trailing " +
          "day supply, Allow Substitution was added to all 25 and the FDA " +
          "compounded topical finasteride alert was added to two products.",
  ...
  },
  {
    ...
    "drugFormulation": "Tretinoin 0.025% topical cream, 20 g tube",
    /* Tretinoin is prescribed at three strengths and a provider copies ONE of
       them. Each is stored in full rather than generated by substituting a
       percentage into a template: these strings are pasted into a prescription,
       so every one is written out here where it can be read and corrected.
       Confirmed by Don 2026-09-15: the three are identical apart from the
       strength, which also changes the favorite name. Same sig, same 1 tube,
       same 0 refills, same 80 days, same reason, same pharmacy notes.
       `tebra` stays the 0.025% record so build-embed.js and the Add-On selector
       see the shape they already expect; `tebraAlso` carries the other two. */
    "tebraAlso": [
      {
        "drugFormulation": "Tretinoin 0.05% topical cream, 20 g tube",
        /* The Tebra drop-down name AT THIS STRENGTH. A commercial product is
           selected, not typed, and the entry differs per strength - without
           this the 0.05% and 0.1% blocks told a provider to pick the 0.025%
           entry. Written out per strength rather than generated by
           substituting a number, the same rule the formulations follow.
           CONFIRMED against Tebra by Don, 2026-09-17. The 0.025% string came
           from the tool; these two were written to its format and he checked
           them on screen: "Tretinoin looks great." */
        "dropdownEntry": "tretinoin 0.05 % topical cream",
      ...
      },
      {
        ...
        /* The Tebra drop-down name AT THIS STRENGTH. A commercial product is
           ...
           from the tool; these two were written to its format and he checked
           them on screen: "Tretinoin looks great." */
        "dropdownEntry": "tretinoin 0.1 % topical cream",
